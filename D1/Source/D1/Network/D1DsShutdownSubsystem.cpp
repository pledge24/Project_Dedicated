...
void UD1DsShutdownSubsystem::BeginShutdownWatch(float InGraceSec)
{
	...
	GetWorld()->GetTimerManager().SetTimer(
		WatchTimerHandle, this, &UD1DsShutdownSubsystem::TickWatch, 1.f, /*bLoop=*/true);
	UE_LOG(LogD1, Log, TEXT("[Match] 종료 감시 시작 — 전원 퇴장 또는 %.0fs 후 DS 종료"), GraceSec);
}

void UD1DsShutdownSubsystem::TickWatch()
{
...
void UD1DsShutdownSubsystem::RequestExit()
{
